...
mesa.homair <- ezlimma::read_linked_xl("homair_stats_nperm10000_mesa/homair_stats_nperm10000_mesa.xlsx")
mesa.homair <- data.frame(X=rownames(mesa.homair), mesa.homair)
setwd("..")
```
...
xx <- list(README=readme, 
           ...
           Hitman_soma_homair=hm.soma.homair, Hitman_met_homair=hm.met.homair, Mesa_homair=mesa.homair)
