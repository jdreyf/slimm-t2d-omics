...
pants.by.grp <- ezlimma::read_linked_xl("absdeltadelta_stats_nperm50000_pants/absdeltadelta_stats_nperm50000_pants.xlsx")
...
```{r combine}
xx <- list(README=readme, SOMAscan=soma, Metabolites=met, soma_met_r=soma.met.cor, Pants_between_arm=pants.by.grp, 
