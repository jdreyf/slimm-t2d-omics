...
We find that the results from not imputing missing values are very similar to those from imputing. For example, if we consider the top 20 metabolites between groups at 3 months, we find that 
