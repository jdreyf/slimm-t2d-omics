...
cor.mat <- cor(t(soma.mat[gene.ind, grep("_0", colnames(soma.mat), value = TRUE)]))
write.csv(signif(cor.mat, digits=6), "data/soma_cor_mat_subset.csv")

cov.mat <- cov(t(soma.mat[gene.ind, grep("_0", colnames(soma.mat), value = TRUE)]))
