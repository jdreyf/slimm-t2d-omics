...
We validate our methods similarly to Barfied et al. (2017) except we simulate omics datasets with hundreds of genes whose significance is assessed with the false discovery rate (FDR) rather than with p-values.
